...
class AGCRN(nn.Module):
    ...
    def __init__(self, input_dim, num_nodes, horizon, batch_size, seq_len,device, rnn_units=64, output_dim=1, num_layers=2, default_graph=True, embed_dim=10, cheb_k=2):
